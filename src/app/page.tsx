    ...
    <main className="relative mx-auto sm:max-w-[600px] lg:max-w-[1400px]">
      ...
      >
        ...
        <p
          ...
          id="more-info"
        >
          Hello there 👋, I&apos;m Simmannaidu Velamala, and I build full-stack web
          apps and cloud solutions with{" "}
          <a
            href="#tech-stack"
          ...
          . AWS Certified &amp; published researcher.
        </p>
        ...
        <div className="motion-preset-slide-right mt-6 flex animate-blur-in-900 items-center gap-4 motion-delay-500">
          ...
          <a
            href="https://www.linkedin.com/in/velamalasimmannaidu/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BJbiC0YBISIi0gnKCGQK7UQ%3D%3D"
            target="_blank"
            aria-label="Linkedin"
          >
            <LinkedinIcon className="h-8 w-8" />
          </a>
          <a href="mailto:velamala.sim@gmail.com" target="_blank" aria-label="Email">
